      ...
      <div className={'TribePageParent'}>
        <AppWrapper id={'TribePageWrapper'}>
            ...
            <div className=''>
              <div className='one'>
                <div className='form-group'>
                  <label htmlFor='exampleInputEmail1'>My family <br/> position is:</label>
                  <select className='form-control round' name='position' id=''
                  ...
                  >
                    <option value='#a82222' style={{textAlign: 'center'}}>Oldest</option>
                    <option value='#224aa8' style={{textAlign: 'center'}}>Older</option>
                    <option value='#224aa8' style={{textAlign: 'center'}}>Middle</option>
                    <option value='#224aa8' style={{textAlign: 'center'}}>Younger</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Youngest</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Twin</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Only Child</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Other</option>
                  </select>
                </div>
              </div>
              <div className='two'>
                <div className='form-group'>
                  ...
                  <select className='form-control round' name='from' id=''
                  ...
                  >
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Australia</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Canada</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Denmark</option>
                    <option value='#224aa8' style={{textAlign: 'center'}}>England</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Finland</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Germany</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Ireland</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>India</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Jamaica</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Kenya</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Malaysia</option>
                    <option value='#224aa8' style={{textAlign: 'center'}}>Northern Ireland</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Nigeria</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Philippines</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Poland</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Romania</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Scotland</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>Sweden</option>
                    <option value='#e8cb61' style={{textAlign: 'center'}}>USA</option>
                    <option value='#a82222' style={{textAlign: 'center'}}>Wales</option>
                    <option value='#224aa8' style={{textAlign: 'center'}}>Not Listed</option>
                  </select>
                </div>
              </div>
              <div className='three'>
                <div className='form-group'>
                  ...
                  <select className='form-control round' name='iam' id=''
                          onChange={(e)=>{
                            let {formTribe} = this.state;
                            let index = e.nativeEvent.target.selectedIndex;
                             let val = e.nativeEvent.target[index].text
                  ...
                  >
                    ...
                    <option value='#e8cb61' style={{textAlign: 'center'}}>an optimist</option>
                    <option value='#a82222' style={{textAlign: 'center'}}>a pessimist</option>
                    <option value='#224aa8' style={{textAlign: 'center'}}>a reacher</option>
                  </select>
                </div>
              </div>
              <div className='four'>
                <div className='form-group'>
                  ...
                  <select className='form-control round' name='maybe' id=''
                          onChange={(e)=>{
                            let {formTribe} = this.state;
                            let index = e.nativeEvent.target.selectedIndex;
                            let val = e.nativeEvent.target[index].text
                  ...
                  >
                    <option value='#e8cb61' style={{textAlign: 'center'}}>better yet</option>
                    <option value='#a82222' style={{textAlign: 'center'}}>less deceived</option>
                    <option value='#224aa8' style={{textAlign: 'center'}}>fearless except</option>
                  </select>
                </div>
              </div>
            </div>
          ...
          <div className='select_btn'>
            <button className='btn final' style={{ background: 'green' }}
                    onClick={(e) => {
                      localStorage.setItem('tribe',JSON.stringify(this.state.formTribe));
